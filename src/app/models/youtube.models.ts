...
export class Convert {
    public static toYoutubeResp(json: string): YoutubeResp {
        return cast(JSON.parse(json), r("YoutubeResp"));
    }

    public static youtubeRespToJson(value: YoutubeResp): string {
        return JSON.stringify(uncast(value, r("YoutubeResp")), null, 2);
    }
}
